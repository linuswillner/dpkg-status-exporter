...
// Only allow manual overrides in debug mode for security reasons
const dpkgStatusLocationOverride = process.env.DEBUG && process.argv[0]
...
http.createServer(async (req, res) => {
  ...
  if (req.url !== '/' && req.url !== '/favicon.ico') {
    ...
    try {
      ...
      console.error('Could not export and send /var/lib/dpkg/status index:\n', err)
